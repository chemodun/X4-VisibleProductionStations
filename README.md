...
- **Steam Workshop**: [Visible Production Stations](https://steamcommunity.com/sharedfiles/filedetails/?id=0) - only for **Game version 8.00** with latest Steam version of the `UI Extensions and HUD` mod (version 80.43 from April 8).
- **Nexus Mods**: [Visible Production Stations](https://www.nexusmods.com/x4foundations/mods/0)
